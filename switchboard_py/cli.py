...
def main():
    ...
    start_project_parser.add_argument('project_name', type=str, required=True, help='Name of the project')
    start_project_parser.add_argument('cloud_provider', type=str, required=True, action='ValidateArg', help='Cloud Provider being used')
